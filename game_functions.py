...
def check_keyup_events(event, ai_settings, screen, ship, bellets):
...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	# Создание пришельца и определение количество пришельцев в ряду
	alien = Alien(ai_settings, screen)
...
def get_number_rows(ai_settings, ship_height, alien_height):
	...
	nuber_rows = int(available_space_y / (2 * alien_height))
	return nuber_rows
